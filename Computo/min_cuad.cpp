/* Daianna Gonzalez Padilla.
   ...
   Programa 5: Aproximacion funcional por el metodo de minimos cuadrados 
...
int main(int argc, char *argv[])
{
    ...
    while (empezar==1) {
       ...
       //Finalmente se liberan todos los bloques reservados
       for(j= 0; j< tam_columnas; j++){
        free(matriz[j]);  }
       for(k= 0; k<t; k++){
        free(puntos[k]);
       ...
       //Se vuelve a preguntar al usuario si desea ajustar otro conjunto de puntos
        printf("Para ajustar otro conjunto de puntos oprima 1, para salir 2\n");
        scanf ("%d", &empezar);
