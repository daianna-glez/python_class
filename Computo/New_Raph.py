...
while empezar == 1:
    ...
    # Funcion para obtener la raiz en cada intervalo: se obtiene Xo y los siguientes X evaluando el valor previo de X en expr
    def soluciones(intervalo, expr, k):
        ...
        print("Error relativo: ",np.format_float_scientific(abs((y - x) / y),precision = 1, exp_digits=3))
    ...
    print("Con base en la grafica de la funcion determine el intervalo que contiene a la o las raices de interes.\n")
